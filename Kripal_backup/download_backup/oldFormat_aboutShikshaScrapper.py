...
a = 0
b = 30
df = pd.read_csv("/home/cd_scrapers/shiksha_vs_collegedunia/input_folder/colleges_data.csv")[a:b]
...
for college in inputNameAndUrlDict:
    ...
    try:
        ...
        try:
            ...
            if about_section is not None:
                ...
                if highlight_section_1 is not None:
                    ...
                    for row in table_rows:
                        try:
                            row_dict[row.findAll('td')[0].text.strip() + "_highlights"] = row.findAll('td')[1].text.strip()
                ...
                for row in table_rows:
                    try:
                        if row.findAll('td')[0].text.strip().lower() == "website":
                            row_dict[row.findAll('td')[0].text.strip() + "_highlights"] = row.findAll('td')[1].find('a')['href']
            ...
            print(e)
        # finally:
        #     print("highlists :", highlights_1, highlights_2)
